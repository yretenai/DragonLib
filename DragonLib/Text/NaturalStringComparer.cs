...
public class NaturalStringComparer : IComparer<string>
{
    ...
    /// Prefer this to <see cref="NaturalStringComparer(System.Collections.Generic.IComparer{string}, System.Boolean, System.Boolean)" /> if possible.
    /// </summary>
    ...
    public int Compare(string? str1, string? str2)
    {
        ...
        while (true)
        {
            ...
            else
            {
                ...
                var stringCompare = StringDirectionDescending ?
                    string.Compare(str2, startIndex2, str1, startIndex1, minLength, StringComparison) :
                    string.Compare(str1, startIndex1, str2, startIndex2, minLength, StringComparison);
