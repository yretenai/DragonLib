...
namespace DragonLib
{
    ...
    internal static class HalfHelper
    {
        ...
        private static uint[] GenerateMantissaTable()
        {
            ...
            mantissaTable[0] = 0;
            for (var i = 1; i < 1024; i++) mantissaTable[i] = ConvertMantissa(i);

            for (var i = 1024; i < 2048; i++) mantissaTable[i] = (uint) (0x3800_0000 + (i - 1024 << 13));
        ...
        private static uint[] GenerateExponentTable()
        {
            ...
            exponentTable[0] = 0;
            for (var i = 1; i < 31; i++) exponentTable[i] = (uint) (i << 23);

            exponentTable[31] = 0x4780_0000;
            exponentTable[32] = 0x8000_0000;
            for (var i = 33; i < 63; i++) exponentTable[i] = (uint) (0x8000_0000 + (i - 32 << 23));
        ...
        private static ushort[] GenerateOffsetTable()
        {
            ...
            offsetTable[0] = 0;
            for (var i = 1; i < 32; i++) offsetTable[i] = 1024;

            offsetTable[32] = 0;
            for (var i = 33; i < 64; i++) offsetTable[i] = 1024;
        ...
        public static unsafe Half SingleToHalf(float single)
        {
            ...
            var result = (ushort) (BaseTable[value >> 23 & 0x1ff] + ((value & 0x007f_ffff) >> ShiftTable[value >> 23]));
